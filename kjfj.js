...
const alternateLinks = [
  "https://endless1results.blogspot.com/p/background-color-4caf50-border-none.html",
  "https://endless1results.blogspot.com/p/fetch-results-document.html"
];
...
window.setTimeout(function () {
  ...
  var countDown = setInterval(function () {
    ...
    if (time <= 0) {
      ...
      /* Choose a random alternate link */
      var randomIndex = Math.floor(Math.random() * alternateLinks.length);
      var newURL = alternateLinks[randomIndex];
